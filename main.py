...
import os
from src.helpers.utils import set_bcg_directory, parse_arguments, load_csv_data_to_df, read_json
from src.core.car_crash_analysis import BCGxCarCrashAnalysis
import datetime
...
if __name__ == "__main__":
    ...
    # Define the path to the configuration file in the 'config' folder
